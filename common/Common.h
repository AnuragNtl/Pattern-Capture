...
namespace PatternCapture {
    ...
    class CommonDependency : public CaptureSource<OutputData>, public Transform<InputData, OutputData> {
        public:
            void* operator()(void *input, map<string, string>);
    ...
    template<class InputData, class OutputData>
        OutputData CommonDependency<InputData, OutputData> :: capture(map<string, string> inputMap) {
    ...
    template<class InputData, class OutputData>
       void* CommonDependency<InputData, OutputData> :: operator()(void *input, map<string, string> inputParams) {
            if(input == NULL) {
