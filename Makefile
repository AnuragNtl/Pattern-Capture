...
PatternCapture : CommonUtils.cpp Dependencies.cpp  PatternCapture.cpp core/engine/graphparser/GraphParser.cpp core/engine/graphparser/JsonGraphParser/JsonGraphParser.cpp core/scheduler/Scheduler.cpp
